...
1. generate a permutation sample from null model
...
2. sparse genotype
3. sig threshold
4. number of permutation samples

output:
1. null distribution of cluster size 

TODO:
1. as of (v1.3.0), cluster analysis only supports FAVOR annot and snv
...
class RVcluster:
    ...
    for variant sets in a permutation sample
    ...
    def cluster_analysis(self, sample_id):
        """
        The main function for computing cluster size for a permutation sample
...
def creating_mask(
    ...
    cmac_bins_count = {
        ...
        (101,200): 0, (201,300): 0, (301,1500): 0, (1501,): 0
    }
    # cmac_bins_count = {(101,200): 0, (201,300): 0, (301,400): 0, (401,500): 0, (501,): 0}
...
def creating_mask_sliding_window(locus, vset, maf, mac, use_annot_weights=False):
    ...
    cmac_bins = [(2,2), (3,3), (4,4), (5,5), (6,7), (8,9),
                 ...
                 (61,100), (101,200), (201,300), (301,1500), (1501,3000)]
    # cmac_bins = [(101,200), (201,300), (301,400), (401,500), (501,1000)]
    n_replicates = 50000
    cmac_bins_count = {x: n_replicates for x in cmac_bins}
...
def run(args, log):
    ...
    try:
        ...
        for i in tqdm(
            ...
            log.info(f"Doing permutation sample {i+1} ...")
